...
export default function Home() {
	...
	const contractAddress = "0x5848D0ff33Bd360A966379877b0Ee0490Dbce2c7"
	...
	useEffect(() => {
		...
		const onNewMemo = (
			...
			setMemos((prevState) => [
				...
				{
					address: from,
					timestamp: new Date(timestamp.toString() * 1000),
					message,
					name,
				},
			])
	...
	return (
		<div className={styles.container}>
			<Head>
				<title>Buy Fernando a Coffee!</title>
				<meta name="description" content="Tipping site" />
				<link rel="icon" href="/favicon.ico" />
			</Head>

			<main className={styles.main}>
				<h1 className={styles.title}>Buy Fernando a Coffee!</h1>
				...
				{currentAccount ? (
					<div>
						<form>
							...
							<br />
							<div>
								<label>Send Fernando a message</label>
								<br />
